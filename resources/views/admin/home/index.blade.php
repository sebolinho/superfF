        ...
        <div class="mb-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center py-3 gap-x-3">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-2xl font-medium text-gray-800 dark:text-white mr-3">{{$data['movie']}}</div>
                        </div>
            ...
            <div
                ...
                <div class="flex items-center py-3 gap-x-3">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-2xl font-medium text-gray-800 dark:text-white mr-3">{{$data['tv']}}</div>
                        </div>
            ...
            <div
                ...
                <div class="flex items-center py-3 gap-x-3">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-2xl font-medium text-gray-800 dark:text-white mr-3">{{$data['episode']}}</div>
                        </div>
            ...
            <div
                ...
                <div class="flex items-center py-3 gap-x-3">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-2xl font-medium text-gray-800 dark:text-white mr-3">{{$data['people']}}</div>
                        </div>
