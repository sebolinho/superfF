...
@section('content')
                ...
                <div class="max-w-[6rem] w-full mx-auto">
                    <div
                        ...
                        <img src="{{$listing->imageurl}}"
                             ...
                             alt="Capa do filme {{ isset($listing->title) ? $listing->title : 'conteúdo' }} para assistir online em HD"
                              title="Assistir {{ isset($listing->title) ? $listing->title : 'conteúdo' }} online grátis em HD">
                             
                    </div>
                </div>
                <div class="flex-1">
                    <h3 class="text-xl tracking-tighter font-semibold text-gray-100 line-clamp-1">
    {{ isset($listing->title) && $listing->title !== '' ? $listing->title : 'Título indisponível' }}
</h3>
    ...
    {{ isset($listing->title_sub) && $listing->title_sub !== '' ? $listing->title_sub : 'Episódio Completo disponível agora' }}
</h2>

                    @endif
                    <h1 class="text-3xl tracking-tighter font-semibold text-gray-100 line-clamp-1 hidden lg:block">
    Assistir {{$listing->title}} Online Grátis em HD
</h1>
